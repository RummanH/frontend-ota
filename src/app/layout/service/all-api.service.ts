...
export class AllApiService {
    baseURL = 'http://103.95.97.155:93/';
    // baseURL = 'http://10.192.168.99/FlamingoWebApi/';
    // baseURL = 'http://10.192.168.29/FlamingoWebApi/';

    countryList = this.baseURL + 'CountryDDL';
    cityList = this.baseURL + 'CityDDL?CountryID=';
    registration = this.baseURL + 'RegistrationRequest';
    authenticate = this.baseURL + 'user/authenticate';
