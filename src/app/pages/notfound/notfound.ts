        ...
        <div class="flex items-center justify-center min-h-screen overflow-hidden">
            <div class="flex flex-col items-center justify-center">
                <div class="flex justify-center items-center mb-5">
                    <img width="150px" src="http://103.95.97.155/sabre/assets/img/Sabre-logo_RGB-RED.png" alt="" />
                </div>
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, #E50000 100%, #E50000 100%)">
